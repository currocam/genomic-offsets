...
class TracyWidom(object):
    ...
    def __init__(self, beta=2):
        ...
        dlnf = nd.Derivative(lambda xx: np.log(self.__cdf(-xx)), step =3.33e-3, n=1, order=7)(-x[1])
        ...
        dlnf = nd.Derivative(lambda xx: np.log(1. - self.__cdf(xx)),step =3.33e-3, n=1, order=7)(x[-2])
